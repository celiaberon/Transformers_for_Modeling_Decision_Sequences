...
def parse_args():
    ...
    parser.add_argument('--profile', type=bool, default=False,
                        help='Flag to profile code execution')
    parser.add_argument('--no_overwrite', action='store_false', default=True,
                        help='Flag to prevent overwriting existing data')
    ...
    parser.add_argument('--tau', type=float, default=None,
                        help='Agent: Decay rate for reward-choice history')
    ...
    parser.add_argument('--multiple_domains', action='store_true', default=False,
                        help='Flag to use multiple domains across sessions')
...
def configure_task_params(task_params, multiple_domains=False, config_file='domains.ini'):
    ...
    Args:
        ...
        multiple_domains (bool): Defaults to single domain
        config_file (str): Configuration file for domains (domains.ini or three_domains.ini)

    Returns:
        task_params (dict): Configured task parameters. Fills in defaults if
        not multiple_domains and no parameters are provided.
    """
